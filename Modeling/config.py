...
# Most transactions are completed in 3-5 minutes, with fewer short/long outliers.
SERVICE_TIME_VALUES = [2, 3, 4, 5, 6, 7, 8]
SERVICE_TIME_PROBABILITIES = [0.04, 0.13, 0.30, 0.25, 0.15, 0.09, 0.04]
